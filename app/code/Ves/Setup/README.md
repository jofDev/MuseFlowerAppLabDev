# Venustheme Magento 2 Setu[]

## Module magento 2 setup to use export/import magento 2 extension sample data.
Allow export venustheme extension sample data
Allow import venustheme extensions json sample data into database
