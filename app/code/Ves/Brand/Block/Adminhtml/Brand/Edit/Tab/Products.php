...
class Products extends Extended
{
    ...
    public function getBrand()
    {
        ...
        var_dump($this->_coreRegistry->registry('current_brand'));
  ...
  /*  public function getSelectedBrandProducts()
    ...
    {
        $products = [];
            if(!empty($this->_coreRegistry->registry('current_brand')->getData('productIds'))){
            foreach ($this->_coreRegistry->registry('current_brand')->getData('productIds') as $product) {
                $products[$product] = ['product_position' => $product];
            }
        }
        return $products;
    }
