...
class CarrierShipping extends AbstractCarrierOnline implements CarrierInterface
{
    ...
    public function getAllowedMethods()
    {
        ...
        return ['regular_shipping' => $this->getConfigData('title')];
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        foreach ($this->getAllowedMethods() as $code => $title) {
            ...
            $method->setMethodTitle(__($title)."  ".$this->getRegularShippingDescriptionConfigValue());
            ...
            // Carrier with such method not found: error in checkout page - fix
            $shippingMethod = $method->getCarrier().'_'.$method->getMethod();
            $this->_checkoutSession->getQuote()->getShippingAddress()->setShippingMethod($shippingMethod);
        }
        return $result; 
    }
