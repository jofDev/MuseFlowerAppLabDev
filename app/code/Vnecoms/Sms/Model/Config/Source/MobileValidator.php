...
class MobileValidator extends \Magento\Framework\DataObject implements \Magento\Framework\Option\ArrayInterface
{
    /**
    ...
    public function toOptionArray()
    {
        $options = [
            ['value'=>'', 'label'=>'Disable'],
            ['value'=>'libphonenumber', 'label'=>'Libphonenumber']
        ];
